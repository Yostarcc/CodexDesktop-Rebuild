...
const RULES = [
  {
    ...
    from: "t.set(ab,{...e.progress,hostId:e.hostId,updatedAtMs:Date.now()}),e.progress.phase===`ready`",
    to: "t.set(ab,{...e.progress,hostId:e.hostId,updatedAtMs:Date.now()}),e.progress?.phase===`ready`",
  },
  {
