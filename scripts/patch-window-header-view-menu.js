...
const RULES = [
  {
    ...
    from: "se={...x(`openCommandMenu`),acceleratorWorksWhenHidden:!0,visible:!1,click:async()=>{await A()}}",
    to: "se={...x(`openCommandMenu`),acceleratorWorksWhenHidden:!0,click:async()=>{await A()}}",
  },
  {
    id: "show_search_files",
    from: "ce={...x(`searchFiles`),acceleratorWorksWhenHidden:!0,visible:!1,click:ee}",
    to: "ce={...x(`searchFiles`),acceleratorWorksWhenHidden:!0,click:ee}",
  },
  {
    id: "show_search_chats",
    from: "le={...x(`searchChats`),acceleratorWorksWhenHidden:!0,visible:!1,click:j}",
    to: "le={...x(`searchChats`),acceleratorWorksWhenHidden:!0,click:j}",
  },
  // {
